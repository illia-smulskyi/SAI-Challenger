...
def test_set_create_only_port_attribute_fails(
    ...
    original_oid = get_oid_attr(phy, connector_oid, attr)
    ...
    assert get_oid_attr(phy, connector_oid, attr) == original_oid
